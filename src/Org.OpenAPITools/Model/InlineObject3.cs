...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject3 :  IEquatable<InlineObject3>, IValidatableObject
    {
        ...
        public InlineObject3(string phone = default(string), string account = default(string), string secret = default(string), int time = default(int), string token = default(string), string paymentpass = default(string), string openid = default(string), string from = default(string), List<string> unsigntxjson = default(List<string>), string chaintype = default(string))
        {
            ...
            if (account == null)
            {
                throw new InvalidDataException("account is a required property for InlineObject3 and cannot be null");
            }
            else
            {
            ...
            if (secret == null)
            {
                throw new InvalidDataException("secret is a required property for InlineObject3 and cannot be null");
            }
            else
            {
                this.Secret = secret;
            ...
            if (time == null)
            {
                throw new InvalidDataException("time is a required property for InlineObject3 and cannot be null");
            }
            else
            {
                this.Time = time;
            ...
            if (openid == null)
            {
                throw new InvalidDataException("openid is a required property for InlineObject3 and cannot be null");
            }
            else
            {
                this.Openid = openid;
